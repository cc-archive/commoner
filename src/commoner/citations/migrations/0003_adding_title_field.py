...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Citation.title'
        db.add_column('citations_citation', 'title', orm['citations.citation:title'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Citation.title'
        db.delete_column('citations_citation', 'title')
