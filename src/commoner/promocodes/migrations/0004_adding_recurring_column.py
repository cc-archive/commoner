...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PromoCode.recurring_contribution_id'
        db.add_column('promocodes_promocode', 'recurring_contribution_id', orm['promocodes.promocode:recurring_contribution_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PromoCode.recurring_contribution_id'
        db.delete_column('promocodes_promocode', 'recurring_contribution_id')
