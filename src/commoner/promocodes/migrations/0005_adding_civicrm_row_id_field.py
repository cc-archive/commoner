...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PromoCode.civicrm_id'
        db.add_column('promocodes_promocode', 'civicrm_id', orm['promocodes.promocode:civicrm_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PromoCode.civicrm_id'
        db.delete_column('promocodes_promocode', 'civicrm_id')
