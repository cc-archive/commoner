...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PromoCode.contribution_id'
        db.delete_column('promocodes_promocode', 'contribution_id')
        
        # Changing field 'PromoCode.created'
        # (to signature: django.db.models.fields.DateTimeField(auto_now_add=True, blank=True))
        db.alter_column('promocodes_promocode', 'created', orm['promocodes.promocode:created'])
        
        # Changing field 'PromoCode.civicrm_id'
        # (to signature: django.db.models.fields.IntegerField())
        db.alter_column('promocodes_promocode', 'civicrm_id', orm['promocodes.promocode:civicrm_id'])
        
    
    
    def backwards(self, orm):
        
        # Adding field 'PromoCode.contribution_id'
        db.add_column('promocodes_promocode', 'contribution_id', orm['promocodes.promocode:contribution_id'])
        ...
        # Changing field 'PromoCode.civicrm_id'
        # (to signature: django.db.models.fields.IntegerField(default=-1))
        db.alter_column('promocodes_promocode', 'civicrm_id', orm['promocodes.promocode:civicrm_id'])
    ...
    models = {
        ...
        'promocodes.promocode': {
            'civicrm_id': ('django.db.models.fields.IntegerField', [], {}),
