...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PromoCode.recipient'
        # (to signature: django.db.models.fields.EmailField(max_length=75))
        db.alter_column('promocodes_promocode', 'recipient', orm['promocodes.promocode:recipient'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PromoCode.created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 9, 10, 16, 4, 32, 864584)))
        db.alter_column('promocodes_promocode', 'created', orm['promocodes.promocode:created'])
        
        # Changing field 'PromoCode.recipient'
        # (to signature: django.db.models.fields.EmailField(max_length=75, blank=True))
        db.alter_column('promocodes_promocode', 'recipient', orm['promocodes.promocode:recipient'])
